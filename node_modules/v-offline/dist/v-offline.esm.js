...
import VueCompositionApi, { defineComponent, ref, computed, onBeforeUnmount } from '@vue/composition-api';
...
var script = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const events = ref(['online', 'offline', 'load']);
    const url = ref(props.pingUrl || 'https://google.com');
...
export { VOffline, install$1 as default };
//# sourceMappingURL=v-offline.esm.js.map
